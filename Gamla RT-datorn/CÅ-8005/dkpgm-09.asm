...
* C]-8005 TILLSAMANS MED INDIKATORKORTET C]-8006
*
...
*
PIAURD  EQU    $E050     DATASIDAN
PIAURC  EQU    $E051     KONTROLLREG
PIAURS  EQU    $E052     STYRNING
URTAVL  EQU    $E0E0     ADRESS TILL DISPLAY
KEY     EQU    $E0E6     TANGENTAVKODARE
INFLG   EQU    $E0E8     BIT=0 OM TANGENT TRYCKT
